...
namespace Inbrand.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            //try
            //{
            //    //users = await _userService.FindAsync("bipul@gmail.com");
            //}
            //catch (Exception ex)
            //{
            //}
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> CreateSuperAdmin([FromBody] User model)
        {
            var result = await UserManager.CreateAsync(new ApplicationUser { UserName = model.UserName, Email = model.UserName }, model.Password);
            return Ok();
        }
        [HttpPost]
        [Route("Login")]
