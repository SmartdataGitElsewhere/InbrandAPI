...
namespace Unity.SelfHostWebApiOwin
{
    public static class UnityHelpers
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            var myAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(a => a.FullName.StartsWith("Inbrand")).ToArray();

            container.RegisterType(typeof(Startup));

            container.RegisterTypes(
                 GetTypesWithCustomAttribute<ContainerControlledAttribute>(myAssemblies),
